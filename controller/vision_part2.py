...
class Vision_Tracker(Node):
    ...
    def offset_pub(self):
        ...
        # offset = 50  # in mm
        print(self.H_s2a)
        # angle = float(np.arctan2(self.H_s2a[1][3]/self.H_s2a[0][3]))
        # qx, qy, qz, qw = self.get_quaternion_from_euler(0,0,angle)
        ...
        # a_pose.orientation.x = qx
        # a_pose.orientation.y = qy
        # a_pose.orientation.z = qz
        # a_pose.orientation.w = qw
